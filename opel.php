...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="assets/css/opel.css">
...
<div class="header">
    <div class="container_header">
        <div class="part_top">
            <div class="dropdown">
                <button  onclick="myFunction()" class="dropbtn text">
                    <img src="assets/opel_images/opel_menu_icon.jpg" alt=" " class="menu_icon">
                    Menu
                </button>
        ...
        <div class="line">
            <hr class="hr1">
            <img src="assets/opel_images/opel_logo.png" alt= " " class="logo">
            <hr class="hr2">
        </div>
    </div>
</div>
<div class="section_1">
    <div class="container_section">
        <div class="part_left_s1_3">
            <div class="container_text_s">
                <div class="text_s open">
                    Informatii generale despre marca Opel
                </div>
        ...
        <div class="part_right_s1_3">
            <img src="assets/opel_images/opel_logo.png" alt=" " class="img_s1">
        </div>
    </div>
</div>
<div class="section_2">
    <div class="container_section">
        <div class="part_left_s2">
            <div class="slider">
                <div class="slide1">
                    <img src="assets/opel_images/astra_1.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide1">
                    <img src="assets/opel_images/astra_2.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide1">
                    <img src="assets/opel_images/astra_3.jpg" alt="" class="slide_img" />
                </div>
            </div>
        </div>
...
<div class="section_3">
    <div class="container_section">
        ...
        <div class="part_right_s1_3">
            <div class="slider">
                <div class="slide2">
                    <img src="assets/opel_images/corsa_1.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide2">
                    <img src="assets/opel_images/corsa_2.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide2">
                    <img src="assets/opel_images/corsa_3.jpg" alt="" class="slide_img" />
                </div>
            </div>
        </div>
    </div>
</div>
<script src="assets/js/opel.js"></script>
</body>
</html>