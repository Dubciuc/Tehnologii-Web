...
<div class="section_1">
    <div class="container_section">
        <div class="part_left_s1_3">
            <div class="container_text_s">
                <div class="text_s open">
                    Informatii generale despre marca Volkswagen
                </div>
                <div class="text_show close">
                    Volkswagen (un cuvânt german care se citește [ pron. folks-va-găn ] și se prescurtează în vorbirea curentă cu „VW” (citit ,,fau ve") este o companie constructoare de autoturisme și SUV-uri din Wolfsburg, Germania.
        ...
        <div class="part_right_s1_3">
            <img src="assets/vw_images/Volkswagen_logo_2.svg.png" alt=" " class="img_s1">
        </div>
    </div>
</div>
<div class="section_2">
    <div class="container_section">
        <div class="part_left_s2">
            <div class="slider">
                <div class="slide1">
                    <img src="assets/vw_images/passat_1.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide1">
                    <img src="assets/vw_images/passat_2.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide1">
                    <img src="assets/vw_images/passat_3.png" alt="" class="slide_img" />
                </div>
            </div>
        </div>
...
<div class="section_3">
    <div class="container_section">
        <div class="part_left_s1_3">
            <div class="container_text_s">
                <div class="text_s open">
                    Modelul: Volkswagen Golf
                </div>
                <div class="text_show close">
                    Volkswagen Golf este o mașină compactă produsă de Volkswagen.
        ...
        <div class="part_right_s1_3">
            <div class="slider">
                <div class="slide2">
                    <img src="assets/vw_images/golf_1.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide2">
                    <img src="assets/vw_images/golf_2.jpg" alt="" class="slide_img" />
                </div>
                <div class="slide2">
                    <img src="assets/vw_images/golf_3.jpg" alt="" class="slide_img" />
                </div>
            </div>
        </div>
    </div>
